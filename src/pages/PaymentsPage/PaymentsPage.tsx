        ...
        <Box className="payments-page">
          <Box className="payments-page__header">
            ...
            <Box className="payments-page__actions">
              <Button className="payments-page__button" variant="outlined">
                Export
              </Button>
              <Button className="payments-page__button" variant="outlined">
                Import
              </Button>
              <Button className="payments-page__button" variant="contained">
                + New Invoice
              </Button>
            </Box>
          </Box>
              ...
              <Box className="payments-page__chips">
                {statusFilters.map((item) => (
                  <Button
                    ...
                    variant={statusFilter === item ? 'contained' : 'outlined'}
