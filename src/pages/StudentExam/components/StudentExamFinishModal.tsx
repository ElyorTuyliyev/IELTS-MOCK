...
} from '../pages/StudentExamPlayerPage.style'
...
export function StudentExamFinishModal({
  ...
  return (
    <StudentExamPlayerFinishDialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <FinishModalActions>
        <Button variant="secondary" className="finish-modal__cancel" onClick={onClose}>
          Cancel
        </Button>
        <Button variant="primary" className="finish-modal__continue" onClick={onContinue}>
          CONTINUE →
        </Button>
      </FinishModalActions>
    </StudentExamPlayerFinishDialog>
